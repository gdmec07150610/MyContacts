...
public class ContactsTable {
    private final static String TABLENAME="contactsTables";
    private MyDB db;
    public ContactsTable(Context context){
        db=new MyDB(context);
        if (!db.isTableExits(TABLENAME)){
            String createTablesSql="CREATE TABLE IF NOT EXISTS"+TABLENAME+"(id_DB integer"+
            ...
            db.creareTable(createTablesSql);
        }
    }
